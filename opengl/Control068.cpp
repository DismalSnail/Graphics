// glControl.cpp: implementation of the Control068 class.
//
//////////////////////////////////////////////////////////////////////
...
Control068::Control068(COpenGL *pGL)
{
	...
	m_bMouseRDown=false;
	m_pOpenGL=pGL;
	m_pCamera=pGL->m_pCamera;
	m_fStep[0]=0.01;
	m_fStep[1]=0.01;
	m_fKeyStep = 3;
}

Control068::~Control068()
{

}

bool Control068::PreTranslateMessage(unsigned int message, unsigned int wParam, unsigned int lParam)
{
	CPoint pt;
	pt.x = LOWORD(lParam);
	pt.y = HIWORD(lParam);
...
bool Control068::MouseCtrlView(int message, CPoint pt)
{
	bool ret=false;
...
bool Control068::SetKeyStatus(unsigned int nChar, bool bVal)
{
...
bool Control068::KeyboardCtrlView()
{
...
void Control068::SetSpeed(float ms, float rs)
{
	m_fStep[0]=ms;
	m_fStep[1]=rs;
}
